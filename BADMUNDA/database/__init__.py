...
from BADMUNDA import DB_NAME, DB_URI, LOGGER

try:
    BADMUNDA_db_client = MongoClient(DB_URI)
except PyMongoError as f:
    LOGGER.error(f"Error in Mongodb: {f}")
    exiter(1)
BADMUNDA_main_db = BADMUNDA_db_client[DB_NAME]
...
class MongoDB:
    ...
    def __init__(self, collection) -> None:
        self.collection = BADMUNDA_main_db[collection]
    ...
    @staticmethod
    def close():
        return BADMUNDA_db_client.close()

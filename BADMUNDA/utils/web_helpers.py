...
from BADMUNDA.bot_class import LOGGER, MESSAGE_DUMP, BAD
from BADMUNDA.utils.http_helper import *
from BADMUNDA.utils.sticker_help import resize_file_to_sticker_size
...
async def youtube_downloader(c:BAD,m:Message,query:str,is_direct:bool,type_:str):
    if type_ == "a":
        # opts = song_opts
        video = False
        song = True

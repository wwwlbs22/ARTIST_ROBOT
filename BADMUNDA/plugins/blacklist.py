...
from BADMUNDA.utils.custom_filters import command, owner_filter, restrict_filter
from BADMUNDA.utils.kbhelpers import ikb


@BAD.on_message(command("blacklist") & filters.group)
...
@BAD.on_message(command("addblacklist") & restrict_filter)
...
@BAD.on_callback_query(filters.regex("^rm_allblacklist$"))

...
from BADMUNDA.utils.msg_types import Types, get_note_type
...
@BAD.on_message(command("save") & admin_filter & ~filters.bot)
...
async def get_note_func(c: BAD, m: Message, note_name, priv_notes_status):
...
async def get_raw_note(c: BAD, m: Message, note: str):
...
@BAD.on_message(filters.regex(r"^#[^\s]+") & filters.group & ~filters.bot)
async def hash_get(c: BAD, m: Message):
...
@BAD.on_message(command("get") & filters.group & ~filters.bot)
async def get_note(c: BAD, m: Message):
...
@BAD.on_message(command(["privnotes", "privatenotes"]) & admin_filter & ~filters.bot)
...
@BAD.on_message(command("notes") & filters.group & ~filters.bot)
...
@BAD.on_message(command("clear") & admin_filter & ~filters.bot)
...
@BAD.on_message(command("clearall") & owner_filter & ~filters.bot)
...
@BAD.on_callback_query(filters.regex("^clear_notes$"))

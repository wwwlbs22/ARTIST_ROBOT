...
from BADMUNDA import HELP_COMMANDS, LOGGER
from BADMUNDA.bot_class import BAD
from BADMUNDA.database.disable_db import Disabling
from BADMUNDA.utils.custom_filters import (admin_filter, can_change_filter,
                                         command, owner_filter)


@BAD.on_message(command("disable") & can_change_filter)
...
@BAD.on_message(command("disabledel") & can_change_filter)
...
@BAD.on_message(command("enable") & can_change_filter)
...
@BAD.on_message(command("disableable") & can_change_filter)
...
@BAD.on_message(command("disabled") & admin_filter)
...
@BAD.on_message(command("enableall") & owner_filter)
...
@BAD.on_callback_query(filters.regex("^enableallcmds$"))
